<!-- todo remove notification taksk -->
<template>
  <div class="wrapper">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown messages-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <span class="label label-success">{{ state.messages.count }}</span>
              </a>
              <ul class="dropdown-menu">
                <li class="header">You have {{ state.messages.count }} messages</li>
                <li>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="pageLink" v-on:click="toggleMenu"><a href="javascript:;" v-on:click="logout"><i class="fa fa-circle-o text-red"></i> <span class="page">Logout</span></a></li>
        </ul>
        <!-- /.sidebar-menu -->
      </section>
      <!-- /.sidebar -->
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">{{capitalize($route.name)}}</li>
        </ol>
      </section>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; <a href="#">CoPilot</a>.</strong> All rights reserved.
    </footer>
  </div>
  <!-- ./wrapper -->
</template>
...
module.exports = {
  ...
  methods: {
    ...
    logout: function () {
      ...
      this.$store.commit('REDIRECT_TO', '/login')
    }
  },
  created: function () {
